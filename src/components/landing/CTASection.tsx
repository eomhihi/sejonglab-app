  ...
  return (
    <section className="py-16 sm:py-24 bg-brand-light relative overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute -top-24 -right-24 w-96 h-96 bg-brand-secondary/10 rounded-full blur-3xl" />
      ...
      <div className="relative max-w-7xl mx-auto px-4 text-center">
        ...
        <h2 className="text-2xl sm:text-3xl lg:text-4xl font-extrabold text-header-footer mb-4 leading-tight drop-shadow-sm font-display k-keep">
          세종시민 패널에 참여해 보세요
        </h2>
        <p className="text-base sm:text-lg text-header-footer font-medium mb-8 sm:mb-10 max-w-xl mx-auto leading-relaxed k-keep">
