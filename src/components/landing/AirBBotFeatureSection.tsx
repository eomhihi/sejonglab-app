      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
          {steps.map((step, i) => (
            ...
            >
              <div className={`inline-flex items-center justify-center w-14 h-14 bg-white border-2 border-brand-secondary/70 rounded-xl mb-5`}>
                <step.Icon className="w-7 h-7 text-brand-secondary" />
              </div>
