...
export function SejongFooter({ isAdmin = false }: SejongFooterProps) {
  return (
    <footer className="bg-header-footer text-slate-200">
      <div className="max-w-7xl mx-auto px-4 py-12 sm:py-16">
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
          {/* 브랜드 */}
          <div className="sm:col-span-2 lg:col-span-1">
            <SejongLogoLockup variant="footer" className="mb-4" />
            <p className="text-sm text-slate-300 leading-relaxed mb-4 k-keep">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li>
                <Link href="/mypage" className="text-slate-300 hover:text-white transition-colors">
                  마이페이지
                </Link>
              </li>
            </ul>
        ...
        <div className="mt-12 pt-8 border-t border-white/10 flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-xs text-neutral-500">
            © 2026 Sejong Lab. All Rights Reserved. Powered by 세종리서치데이터연구소
          </p>
          <div className="flex items-center gap-4 text-xs text-slate-400">
            ...
            <div className="flex items-center gap-2 text-xs">
              ...
              <span className="text-brand-ash/80">|</span>
