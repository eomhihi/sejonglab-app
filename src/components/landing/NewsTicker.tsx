...
export function NewsTicker({ initialNews }: NewsTickerProps) {
...
export function NewsSection({ initialNews }: NewsTickerProps) {
  return (
    <section className="bg-sky-50 py-10 border-y border-sky-100">
      <div className="max-w-7xl mx-auto px-4">
        <div className="flex flex-col lg:flex-row gap-6">
          ...
          {/* 우측 뉴스 리스트 (스크롤 가능) */}
          <div
            className="flex-1 h-40 overflow-y-auto pr-2 scrollbar-thin"
            style={{
              scrollbarWidth: "thin",
