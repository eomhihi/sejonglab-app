      ...
      <div className="max-w-7xl mx-auto w-full px-4">
        <div className="flex items-start justify-between gap-4">
          <div className="min-w-0 flex flex-col items-start">
            ...
            <span
              className="mt-0.5 text-[11px] sm:text-xs font-semibold uppercase text-gray-500 tracking-[0.62em] pl-[0.62em]"
              style={{ fontFamily: "var(--font-montserrat)" }}
            >
              Research Data
            </span>
          ...
          <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-2 sm:gap-3 flex-shrink-0 pt-0.5">
            ...
            <Link
              href="/signup"
              className="h-11 px-4 rounded-xl bg-slate-900 text-white text-sm font-extrabold hover:bg-slate-800 transition inline-flex items-center justify-center"
              style={{ fontFamily: "var(--font-montserrat)" }}
            >
              패널 모집
            </Link>
