...
// 세종시 24개 읍면동 (1읍 · 9면 · 14행정동) — 가나다순. + 세종 외 거주자용 catch-all
export const REGION_OPTIONS = [
  "고운동", "금남면", "나성동", "다정동", "대평동", "도담동", "반곡동", "보람동",
  "부강면", "새롬동", "소담동", "소정면", "아름동", "어진동", "연기면", "연동면",
  "연서면", "장군면", "전동면", "전의면", "조치원읍", "종촌동", "한솔동", "해밀동",
  "세종 외 지역(대전, 청주 등)",
] as const;
...
export const SIGNUP_PATH_VALUES = [...SIGNUP_PATH_OPTIONS] as [string, ...string[]];
